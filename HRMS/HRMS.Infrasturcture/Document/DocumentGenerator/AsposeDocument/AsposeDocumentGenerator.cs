...
namespace HRMS.Infrastructure.Document.DocumentGenerator.AsposeDocument
{
    /// <summary>
    ...
    public class AsposeDocumentGenerator
    {
        ...
        /// </summary>
        private static Aspose.Words.Document BuildDocument(string templatePath, DocTemplateModel model)
        {
        ...
        /// </summary>
        private static byte[] SaveToStream(Aspose.Words.Document doc, SaveFormat format)
        {
        ...
        /// </summary>
        private static void InsertTextFields(Aspose.Words.Document doc, DocTemplateModel model)
        {
        ...
        /// </summary>
        private static void InsertImages(Aspose.Words.Document doc, DocTemplateModel model)
        {
        ...
        /// </summary>
        private static void InsertTables(Aspose.Words.Document doc, DocTemplateModel model)
        {
        ...
        /// </summary>
        private static void ReplacePlaceholderWithImage(Aspose.Words.Document doc, string placeholder, string imagePath, ImageFieldDimension dimension)
        {
            var options = new FindReplaceOptions
            {
        ...
        /// </summary>
        private static void ReplacePlaceholderWithImage(Aspose.Words.Document doc, string placeholder, Stream imageStream, ImageFieldDimension dimension)
        {
            var options = new FindReplaceOptions
            {
