...
namespace HRMS.Infrastructure.Document.DocumentGenerator.AsposeDocument
{
    ...
    public class ReplaceWithTableHandler : IReplacingCallback
    {
        ...
        /// </summary>
        /// <param name="doc">The Aspose <see cref="Aspose.Words.Document"/> where the table will be inserted.</param>
        /// <param name="table">The table data and styles (<see cref="DocTemplateTableField"/>).</param>
        public ReplaceWithTableHandler(Aspose.Words.Document doc, DocTemplateTableField table)
        {
            _table = table;
