...
namespace HRMS.Infrastructure.Document.DocumentGenerator.AsposeDocument
{
    ...
    public class ReplaceWithImageHandler : IReplacingCallback
    {
        ...
        {
            var doc = (Aspose.Words.Document)args.MatchNode.Document;
        ...
        /// </summary>
        private ReplaceAction InsertFallbackImage(ReplacingArgs args, Aspose.Words.Document doc)
        {
        ...
        private static Run InsertPlaceholderRun(Aspose.Words.Document doc, Run firstRun, int index)
        {
        ...
        /// </summary>
        private void InsertImageAt(Aspose.Words.Document doc, Run placeholder)
        {
            var builder = new DocumentBuilder(doc);
