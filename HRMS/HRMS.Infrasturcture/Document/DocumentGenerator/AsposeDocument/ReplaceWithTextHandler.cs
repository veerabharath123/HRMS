...
namespace HRMS.Infrastructure.Document.DocumentGenerator.AsposeDocument
{
    ...
    public class ReplaceWithTextHandler : IReplacingCallback
    {
        ...
        {
            var document = (Aspose.Words.Document)args.MatchNode.Document;
        ...
        /// </summary>
        private static void InsertFallbackText(Aspose.Words.Document doc, Node matchNode, DocTemplateTextField field)
        {
        ...
        /// </summary>
        private static void InsertStyledRun(Aspose.Words.Document doc, Run firstRun, int index, DocTemplateTextField field)
        {
